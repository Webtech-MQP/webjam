        ...
        <div className="group flex flex-row-reverse items-center mt-2">
            ...
            {Array.from({ length: 10 }).map((_, index) => (
                <button
                    ...
                    className={cn('box-content w-2.5 flex-0',
                        isAdmin ? 'text-muted-foreground pl-1'
                            : 'cursor-pointer peer hover:text-primary hover:fill-primary peer-hover:fill-primary peer-hover:text-primary text-muted-foreground pl-1',
                        index % 2 == 0 && 'rotate-y-180 pl-0',
                        myRating >= 10 - index ? cn('text-primary fill-primary', !isAdmin && 'group-hover:fill-none') : '')}
                >
