    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                caption_label: cn('select-none font-medium', captionLayout === 'label' ? 'text-sm' : 'rounded-md pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-muted dark:text-muted-foreground [&>svg]:size-3.5', defaultClassNames.caption_label),
                table: 'w-full border-collapse',
                weekdays: cn('flex', defaultClassNames.weekdays),
                weekday: cn('text-muted dark:text-muted-foreground rounded-md flex-1 font-normal text-[0.8rem] select-none', defaultClassNames.weekday),
                week: cn('flex w-full mt-2', defaultClassNames.week),
                week_number_header: cn('select-none w-(--cell-size)', defaultClassNames.week_number_header),
                week_number: cn('text-[0.8rem] select-none text-muted dark:text-muted-foreground', defaultClassNames.week_number),
                ...
                outside: cn('text-muted dark:text-muted-foreground aria-selected:text-muted dark:text-muted-foreground', defaultClassNames.outside),
                disabled: cn('text-muted dark:text-muted-foreground opacity-50', defaultClassNames.disabled),
