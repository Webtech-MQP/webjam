...
export function CandidateSearch({ initialPage = 1, initialSearchParams = {} }: CandidateSearchProps) {
    ...
    const [searchParams, setSearchParams] = useState({
        ...
        experience: initialSearchParams.experience || '',
        githubUsername: initialSearchParams.githubUsername || '',
    });
