        ...
        <div className="space-y-4">
                        ...
                        <div className="grid gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="rounded-lg border max-h-[220px] overflow-y-auto">
                                    ...
                                    {selectedQuestions.length === 0 && <div className="p-4 text-center text-sm text-muted-foreground dark:text-muted-foreground">No questions selected</div>}
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="rounded-lg border max-h-[220px] overflow-y-auto">
                                    ...
                                    {availableQuestions.length === 0 && <div className="p-4 text-center text-sm text-muted-foreground dark:text-muted-foreground">No available questions</div>}
                                </div>
                            </div>
                        </div>
            ...
            <div className="rounded-lg border">
                {selectedQuestions.map((question, index) => (
                    ...
                    >
                        <span className="text-sm text-muted-foreground dark:text-muted-foreground">{index + 1}.</span>
                        <div>
                            <p className="text-sm font-medium">{question.question}</p>
                            <p className="text-sm text-muted-foreground dark:text-muted-foreground">
                                {question.type} {question.required ? '(Required)' : '(Optional)'}
                ...
                {selectedQuestions.length === 0 && <div className="p-4 text-center text-sm text-muted-foreground dark:text-muted-foreground">No registration questions set up yet</div>}
            </div>
        </div>
    );
}
