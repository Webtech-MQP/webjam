...
export default function Page() {
  ...
  const changeProjectVisibility =
    api.candidates.changeProjectVisibility.useMutation({
      onMutate: async (d) => {
        ...
        utils.candidates.getOne.setData(
          ...
          },
          {
            ...
            projects: prev.projects.map((p) =>
              p.projectId === d.projectId ? { ...p, visible: d.visible } : p,
            ),
          },
        );
  ...
  const {
    ...
    error,
    isLoading,
  } = api.candidates.getOne.useQuery(
    userId.startsWith("@")
            ...
            <div className="grid">
              {candidate?.projects.map((p) => (
                ...
                >
                  ...
                  <p className={cn(!p.visible && "line-through")}>
                    {p.project.title}
                  </p>
                </div>
              ))}
